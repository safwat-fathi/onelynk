    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-base-content/60 mt-1">Welcome back! Here's what's happening with your store.</p>
        </div>
      </div>
        ...
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body">
            ...
            <div className="h-64 flex items-center justify-center bg-base-200 rounded">
              <span className="text-base-content/60">Chart placeholder - Last 7 days</span>
            </div>
          </div>
        </div>
              ...
              <table className="table table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>#1003</td>
                    <td>Mike Wilson</td>
                    <td><span className="badge badge-info badge-sm">Shipped</span></td>
                    <td>$245.00</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-base-content/60">Is this product still available?</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-base-content/60">When will my order ship?</p>
