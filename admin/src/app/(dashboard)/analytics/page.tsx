    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-base-content/60 mt-1">Track your performance and insights</p>
        </div>
          ...
          <div className="card-body">
            ...
            <div className="h-64 flex items-center justify-center bg-base-200 rounded">
              <div className="text-center">
                ...
                <span className="text-base-content/60">Sales chart - Last 30 days</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            ...
            <div className="space-y-3">
              {topProducts.map((product, index) => (
                <div key={product.name} className="flex items-center justify-between p-3 bg-base-200 rounded">
                  <div className="flex items-center gap-3">
                    <span className="badge badge-neutral">{index + 1}</span>
                    <div>
                      <p className="font-medium">{product.name}</p>
                      <p className="text-sm text-base-content/60">{product.sales} sales</p>
                    </div>
                  </div>
          ...
          <div className="card-body">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <progress className="progress progress-primary w-20" value="78" max="100"></progress>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <progress className="progress progress-primary w-20" value="72" max="100"></progress>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <progress className="progress progress-primary w-20" value="68" max="100"></progress>
